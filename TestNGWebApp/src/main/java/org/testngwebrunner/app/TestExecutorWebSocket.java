...
public class TestExecutorWebSocket {
	...
	public void onText(Session session, String message) throws Exception {
		...
		if (message.equals("pause")) {
			Registry registry = LocateRegistry.getRegistry("localhost", Constant.EXECUTION_RMI_PORT);
			IExecutionActionRemote executionActionRemote = (IExecutionActionRemote) registry.lookup(Constant.EXECUTION_RMI_ID);
